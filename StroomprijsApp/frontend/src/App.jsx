...
export default function App() {
  ...
  // Profile page
  if (page === "profile") {
    return <ProfilePage onBack={() => setPage("dashboard")} onGoAlerts={() => { setInitialTab("alerts"); setPage("dashboard"); }} />;
  }

  // Main dashboard
  return <Dashboard onGoProfile={() => setPage("profile")} initialTab={initialTab} onTabConsumed={() => setInitialTab("today")} />;
}