    ...
    <div style={{ minHeight: "100vh", background: C.bg, fontFamily: "'DM Sans', system-ui, sans-serif", color: C.text }}>
      ...
      <div style={{ background: `linear-gradient(135deg, #1E3A8A 0%, #1E40AF 60%, #1D4ED8 100%)`, color: "#fff", padding: "72px 24px 64px", textAlign: "center" }}>
        ...
        <div style={{ display: "flex", gap: 14, justifyContent: "center", flexWrap: "wrap" }}>
          <a href="/fleet-audit" style={{ display: "inline-block", padding: "14px 32px", borderRadius: 30, fontSize: 15, fontWeight: 800, background: "#FCD34D", color: "#1E3A8A", textDecoration: "none", boxShadow: "0 6px 24px rgba(0,0,0,0.2)" }}>
      ...
      <div style={{ maxWidth: 860, margin: "0 auto", padding: "52px 20px 80px" }}>
        ...
        {/* Contact / waitlist */}
        <div id="contact" style={{ background: `linear-gradient(135deg, #1E3A8A, #1E40AF)`, borderRadius: 24, padding: "40px 36px", color: "#fff", textAlign: "center" }}>
          ...
          {leadState === "done" ? (
            ...
            <form onSubmit={submitLead} style={{ display: "flex", gap: 10, justifyContent: "center", flexWrap: "wrap", maxWidth: 460, margin: "0 auto" }}>
              ...
              <button
                ...
                style={{ padding: "12px 24px", borderRadius: 30, fontSize: 14, fontWeight: 800, background: "#FCD34D", color: "#1E3A8A", border: "none", cursor: "pointer", whiteSpace: "nowrap" }}
              >
