...
const CONTENT = {
  en: {
    ...
    windowsTitle: "Best Charging Windows Tonight",
    windowsDesc: "Cheapest upcoming hours based on live EPEX Spot prices",
  ...
  nl: {
    ...
    windowsTitle: "Beste laadvensters vanavond",
    windowsDesc: "Goedkoopste komende uren op basis van live EPEX Spot-prijzen",
  ...
  fr: {
    ...
    windowsTitle: "Meilleures plages de charge ce soir",
